...
| Home Wi-Fi presence | Private radio recognition and backend publication passed on one V52. The 11 September log identifies GPS-priority clears separately from normal radio expiry. V3 preserves agreeing Home evidence and exposes fresh router/GPS disagreement as **Location uncertain** across publisher/app/WhatsApp. A conflict cannot select Home or become an arrival/departure. The operator confirmed the Home pin and 50 m radius; the separate School zone is not the cause. General activation/enrollment UI remain disabled. | Partial — private pilot | Pass release gates and the updated physical check with both gateway and app on PR #116. Fresh map/hero/WhatsApp agreement, departure/return, expiry, router restart and enrollment remain open. Report gaps still expire Home honestly; continuous Home and native WIFIFENCE acceptance are not established. No reporting-policy or hardware-setting change is included. See `services/wifi-home-supplier-validation.md` and the acceptance ledger. |
