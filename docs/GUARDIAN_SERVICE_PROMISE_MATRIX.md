...
| Home Wi-Fi presence | One V52/Home radio passed recognition on 7–8 September 2026 UTC and backend publication passed on 8 September. Continuous Home remains unaccepted; isolated five-minute reports exceed the observer's 60-second match gap and 120-second expiry. The native setting has no captured fence reply/event. The quiet radio cycle had 11 heartbeats and no reports; the later 8m38s CR baseline had 14 fresh reports and two CR replies, but no enrolled-router sighting. Its five GPS reports lacked scan metadata. The private capture now reads GPS/non-GPS scan sections directly; 780 gateway tests passed. Native acceptance, persistence/removal and continuous Home remain unconfirmed. General customer activation and enrollment UI remain disabled. | Partial — private pilot | Preserve all captures and the existing setting. Run the updated stationary scan capture before another marked comparison; review provider eligibility separately. Keep reporting policy and expiry unchanged; supplier clarification proceeds in parallel. Fresh Home app/map/hero/WhatsApp agreement, enrollment, departure/return and router restart remain open. See `services/wifi-home-supplier-validation.md` and the real-device acceptance ledger. |
