...
| Home Wi-Fi presence | A private V52 observer, off by default, recognised one operator-selected Home radio in the 7 September 2026 UTC pilot and sustained seven qualifying readings. Customer Home inference, enrollment UI and map activation remain unimplemented. | Not implemented | Owner-authorized customer enrollment, departure/return and router-restart evidence, expiry/revocation, clear Home-source presentation and GPS/SOS/Journey preservation; see `services/wifi-home.md` and the real-device acceptance ledger. |
