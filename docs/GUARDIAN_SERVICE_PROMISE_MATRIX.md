...
| Home Wi-Fi presence | One V52/Home radio passed recognition on 7–8 September 2026 UTC and backend publication passed on 8 September. Continuous Home remains unaccepted; isolated five-minute reports exceed the observer's 60-second match gap and 120-second expiry. The first native trial had one setting handoff, no fence reply/event, 21 heartbeats and 13 fresh reports; both responses were `CR`. A later 12m14s marked radio cycle had 11 heartbeats, zero reports/fence events and no command handoffs. No fresh router baseline was received. Native acceptance remains inconclusive; persistence/removal are unknown. General customer activation and enrollment UI remain disabled. | Partial — private pilot | Preserve both captures and the existing setting. Next compare one protected CR burst with a fresh-router baseline and short marked radio cycle; supplier clarification proceeds in parallel. Keep reporting policy and expiry unchanged. Fresh Home app/map/hero/WhatsApp agreement, enrollment, departure/return and router restart remain open. See `services/wifi-home-supplier-validation.md` and the real-device acceptance ledger. |
