...
| Home Wi-Fi presence | One V52/Home radio passed recognition on 7–8 September 2026 UTC, including mixed Wi-Fi/cellular reports. The one-CR check confirmed a usable backend Home publication on 8 September. Subsequent app/WhatsApp screenshots show retained GPS after radio evidence expired despite recent heartbeats: stationary report acquisition remains an observed gap. The opt-in display pilot has source/time labels and bounded expiry; general customer activation and enrollment UI remain disabled. | Partial — private pilot | Bounded stationary report acquisition and battery validation, fresh Home app/map/hero/WhatsApp visual agreement, owner-authorized customer enrollment, departure/return and router restart; software guards preserve GPS/SOS/Journey evidence. See `services/wifi-home.md` and the real-device acceptance ledger. |
