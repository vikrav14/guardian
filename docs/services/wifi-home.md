...
1. Near-router identity matching passed for one configured V52/radio pair on
   7 September 2026 UTC; stationary expiry/history and gateway restoration passed
   on 13 September UTC. Validate loss/return and router restart before
...
4. Fresh and expired historical Home map/avatar presentation passed on the
   configured watch. Complete ordinary WhatsApp/location-details agreement and
   post-restart app/reconnection acceptance.
