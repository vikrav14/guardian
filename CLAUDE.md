...
| 19 | Safe-zone entry |
| 20 | Bracelet removal |
| 21 | Fall observed on Jesh: 24 September 2026, state `00200000` |
| 22 | Fall alarm |

`gateway/src/protocol/gt06.js` accepts bits 21 and 22 as fall variants, while bit
20 remains bracelet removal. The earlier 21 September report omitted the raw
state. The 24 September 14:25 MUT physical test includes
`AL_LTE state=00200000 fields=25`, primary WhatsApp delivery and an Auto reply;
this confirms bit 21 on Jesh. The operator also confirmed the fall callback
auto-answered; audio and that window's restoration remain unreported. Do not
generalize this mapping to other firmware. Shortened legacy alarm layouts remain
...
1. Preserve the 24 September raw fall state and primary WhatsApp delivery;
   preserve physical fall callback success; verify audio and restoration, investigate the other
   recipient's failed delivery, and retain frozen event-location evidence.
