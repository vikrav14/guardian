class CareWellbeingBackbone {
  ...
  static const List<String> frontendMilestones = <String>['show watch estimates with quality and freshness', 'show device limitations and unconfirmed wearing', 'keep routines behind the Care entitlement', 'direct concerns to a human or appropriate medical help'];
