...
abstract class AppLocalizations {
  ...
  /// No description provided for @navSafeZones.
  ///
  /// In en, this message translates to:
  /// **'Safe zones'**
  ...
  /// No description provided for @sendHelpAlert.
  ///
  /// In en, this message translates to:
  /// **'Send help alert'**
  String get sendHelpAlert;

  /// No description provided for @sendingHelpAlert.
  ///
  /// In en, this message translates to:
  /// **'Sending…'**
  String get sendingHelpAlert;

  /// No description provided for @emergencyNumbersHeading.
  ///
  /// In en, this message translates to:
  /// **'Mauritius emergency numbers'**
  String get emergencyNumbersHeading;
  ...
  /// No description provided for @emergencySamu.
  ///
  /// In en, this message translates to:
  /// **'SAMU'**
  String get emergencySamu;
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) =>
      <String>['en', 'fr', 'mfe'].contains(locale.languageCode);
